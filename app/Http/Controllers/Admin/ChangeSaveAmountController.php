...
//                    }
        ...
        return view('Admin.ChangeSaveAmount.index');
    }

    public function multiDelete(Request $request)
    {
        $ids = explode(",", $request->ids);
        ChangeSaveAmount::whereIn('id', $ids)->delete();
    ...
    public function destroy(ChangeSaveAmount $changeSaveAmount)
    {
        $changeSaveAmount->delete();
        return response()->json(
            [
                'code' => 200,
                'message' => 'تم الحذف بنجاح'
    ...
    public function change_save_amount(Request $request, $id)
    {
        $item = ChangeSaveAmount::where('id', $id)->first();
