...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('lessons.store')}}">
    @csrf
    <div class="row mt-0">
        <!--begin::Input group-->
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 col-md-6 mt-0">
            ...
            <input type="text" class="form-control form-control-solid numbersOnly" placeholder="الرقم" name="number" >
        </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <input type="file" name="image1" class="dropify" data-height="300" />
                </div>
            </div>
        </div><!-- COL END -->
        <div class="col-lg-6">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <textarea type="text" class="form-control form-control-solid" placeholder="الملاحظات" name="notes" ></textarea>
        </div>
