...
@section('page_title') تقارير الغياب @endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تقارير الغياب</h3>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'absence'])
    @include('Admin.Absence.parts.block',['url'=>'change_absence'])
