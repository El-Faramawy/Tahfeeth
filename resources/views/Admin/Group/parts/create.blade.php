<!--begin::Form-->
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('groups.store')}}">
    @csrf
    <div class="row mt-0">
        <!--begin::Input group-->
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <textarea type="text" class="form-control form-control-solid" placeholder="الوصف" name="description" ></textarea>
        </div>
