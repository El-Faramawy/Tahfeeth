...
@section('page_title') حلقات التلاوة @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">حلقات التلاوة</h3>
                    ...
                    <div class="table-responsive">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">المعلم الثانى</th>
                                <th class="text-white">التاريخ</th>
                                <th class="text-white">الوقت</th>
                                <th class="text-white">اللينك</th>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'sessions'])
