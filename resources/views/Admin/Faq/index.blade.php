...
@section('page_title') الاسئلة و الاجابات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">الاسئلة و الاجابات</h3>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'faqs'])
